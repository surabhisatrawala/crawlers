...
for i in ascii_lowercase: 
		for j in ascii_lowercase:
			mappings.append(i+j)
c=open("C:/Python27/nytimes/applist/mainurl_with_tags/applist_mapping.csv",'w')	#create file of name marketcat		
dict_name ={} 
counter = 0
for filename in os.listdir(os.getcwd()): # fetch all files from dictionary
	...
	dict_name[mappings[counter]] = file # indexing of files
 	c.write(":a"+mappings[counter]+","+dict_name[mappings[counter]])#write data into file 
 	c.write("\n")
 	counter += 1
print dict_name
